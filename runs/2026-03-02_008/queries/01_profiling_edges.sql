...
--   4. Save to: runs/2026-03-02_008/results/profiling_edges.csv
--
...
-- Evidence: /private/var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/pytest-of-chris/pytest-14/test_sql_dir_accepted_when_pro0/sql_worksheets/test.sql
...
SELECT
    ...
    1                                               AS frequency,
    '/private/var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/pytest-of-chris/pytest-14/test_sql_dir_accepted_when_pro0/sql_worksheets/test.sql'                           AS evidence
FROM (
    SELECT
