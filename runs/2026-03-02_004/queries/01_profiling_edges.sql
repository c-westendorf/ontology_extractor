...
--   4. Save to: runs/2026-03-02_004/results/profiling_edges.csv
--
...
-- Evidence: /var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/tmpug49kzk8/sql_worksheets/customers_orders.sql
...
SELECT
    ...
    1                                               AS frequency,
    '/var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/tmpug49kzk8/sql_worksheets/customers_orders.sql'                           AS evidence
FROM (
    SELECT
...
-- Evidence: /var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/tmpug49kzk8/sql_worksheets/order_items.sql
-- SQL confidence: 0.95  |  Frequency: 1 file(s)
SELECT
    ...
    0.95                                          AS confidence_sql,
    1                                               AS frequency,
    '/var/folders/32/x61r3nkd55dd30vm0g0c6wp00000gn/T/tmpug49kzk8/sql_worksheets/order_items.sql'                           AS evidence
FROM (
    SELECT
        COUNT(*)                        AS sample_rows,
