...
## Run: `2026-03-02_010_test_label`

Generated: 2026-03-02 16:00 UTC
Source: 1 SQL worksheet(s) → 1 candidate join edges
...
```
runs/2026-03-02_010_test_label/results/profiling_edges.csv
```
...
```
runs/2026-03-02_010_test_label/results/column_profiles.csv
```
...
```
runs/2026-03-02_010_test_label/results/value_overlap.csv
```
...
python -m rigor.pipeline \
    ...
    --run-dir runs/2026-03-02_010_test_label \
    --phase infer
```
...
|---|---|
| test.sql | see query files |

**Top candidate edges by frequency:**
- `TABLE_B.A_ID` → `TABLE_A.ID` (frequency: 1, confidence: 0.95)
...
- **Run ID:** `2026-03-02_010_test_label`
