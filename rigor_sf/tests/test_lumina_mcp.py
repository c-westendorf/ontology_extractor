"""Unit tests for rigor_sf.metadata.lumina_mcp module.
...
from rigor_sf.metadata.lumina_mcp import (
    LuminaMCPConfig,
    LuminaMCPClient,
    CircuitBreaker,
    LuminaResponse,
...
class TestLuminaMCPClient:
    ...
    @patch("rigor_sf.metadata.lumina_mcp.requests.post")
    ...
    def test_fetch_metadata_retries_on_failure(self, mock_post):
        ...
        with patch("rigor_sf.metadata.lumina_mcp.time.sleep"):
            table_comments, column_comments = client.fetch_metadata(["TABLE1"])
...
class TestExponentialBackoff:
    ...
    @patch("rigor_sf.metadata.lumina_mcp.requests.post")
    @patch("rigor_sf.metadata.lumina_mcp.time.sleep")
