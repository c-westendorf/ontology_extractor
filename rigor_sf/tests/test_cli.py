...
from rigor_sf.exit_codes import ExitCode, ConfigError, PrerequisiteError
from rigor_sf.pipeline import main, run, PHASES
...
class TestCLIArgumentParsing:
    ...
    def test_phase_defaults_to_all(self, minimal_config: Path, sample_sql_dir: Path):
        ...
        with mock.patch("rigor_sf.pipeline._get_source_mode", return_value="offline"):
            with mock.patch("rigor_sf.pipeline._load_schema_offline", return_value=[]):
...
class TestPhaseReview:
    ...
    def test_review_launches_streamlit(self, minimal_config: Path):
        ...
        with mock.patch("subprocess.run") as mock_run:
            ...
            from rigor_sf.pipeline import phase_review
...
class TestExitCodes:
    ...
    def test_validation_error_returns_3(self, minimal_config: Path):
        ...
        import pandas as pd
        from rigor_sf.exit_codes import ValidationError
