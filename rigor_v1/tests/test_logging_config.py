"""Unit tests for rigor_v1.logging_config module.
...
from rigor_v1.logging_config import (
    RigorLogFormatter,
    PhaseLogFilter,
    PhaseLogger,
    setup_logging,
...
class TestRigorLogFormatter:
    ...
    def test_shortens_rigor_v1_prefix(self):
        """Formatter should shorten rigor_v1. prefix in logger names."""
        formatter = RigorLogFormatter(include_timestamp=False)
        record = logging.LogRecord(
            name="rigor_v1.pipeline",
            level=logging.INFO,
        ...
        assert "rigor_v1.pipeline" not in formatted
...
class TestGetLogger:
    ...
    def test_normalizes_rigor_v1_name(self):
        """get_logger should normalize rigor_v1 prefix to rigor namespace."""
        logger = get_logger("rigor_v1.pipeline")
