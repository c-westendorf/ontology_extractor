...
from rigor_v1.exit_codes import ExitCode, LLMError
from rigor_v1.llm_provider import (
    LLMResponse,
    with_retry,
        ...
        with mock.patch("rigor_v1.pipeline._get_source_mode") as mock_mode:
            ...
            with mock.patch("rigor_v1.pipeline._load_schema_offline") as mock_schema:
                ...
                with mock.patch("rigor_v1.pipeline.create_provider") as mock_provider:
                    ...
                    with mock.patch(
                        "rigor_v1.llm_provider.prompt_user_recovery",
                        return_value="halt"
                    ):
                        with mock.patch(
                            "rigor_v1.pipeline.prompt_user_recovery",
                            return_value="halt"
                        ):
